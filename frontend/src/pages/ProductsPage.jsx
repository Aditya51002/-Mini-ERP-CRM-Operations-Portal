...
import { ROLES, STOCK_MOVEMENT_TYPES } from "../constants/enums";
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <FormField label="Current stock">
                <input
                  ...
                  onChange={(event) =>
                    setProductForm({ ...productForm, currentStock: event.target.value })
                  }
                />
              </FormField>
              <FormField label="Min stock alert">
                <input
                  ...
                  onChange={(event) =>
                    setProductForm({ ...productForm, minStockAlert: event.target.value })
                  }
                />
              </FormField>
              <FormField label="Location">
                <input
                  ...
                  onChange={(event) =>
                    setProductForm({ ...productForm, location: event.target.value })
                  }
                />
              </FormField>
            </div>
        ...
        <Modal title={`Adjust stock · ${stockProduct.sku}`} onClose={() => setStockProduct(null)}>
          ...
          <form className="grid gap-4" onSubmit={adjustStock}>
            <p className="text-sm text-slate-600">
              Current stock:{" "}
              <span className="font-semibold text-ink">{stockProduct.currentStock}</span>
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              <FormField label="Movement type">
                ...
                >
                  <option value={STOCK_MOVEMENT_TYPES.IN}>{STOCK_MOVEMENT_TYPES.IN}</option>
                  <option value={STOCK_MOVEMENT_TYPES.OUT}>{STOCK_MOVEMENT_TYPES.OUT}</option>
                </select>
              </FormField>
